...
public interface AirportSoap {
    ...
    @RequestWrapper(localName = "getAirportInformationByISOCountryCode", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByISOCountryCode")
    @ResponseWrapper(localName = "getAirportInformationByISOCountryCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByISOCountryCodeResponse")
    ...
    @RequestWrapper(localName = "getAirportInformationByCityOrAirportName", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByCityOrAirportName")
    @ResponseWrapper(localName = "getAirportInformationByCityOrAirportNameResponse", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByCityOrAirportNameResponse")
    ...
    @RequestWrapper(localName = "GetAirportInformationByCountry", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByCountry")
    @ResponseWrapper(localName = "GetAirportInformationByCountryResponse", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByCountryResponse")
    ...
    @RequestWrapper(localName = "getAirportInformationByAirportCode", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByAirportCode")
    @ResponseWrapper(localName = "getAirportInformationByAirportCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "airport_info.GetAirportInformationByAirportCodeResponse")
