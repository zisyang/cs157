    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(currency_converter.CurrencyConvertor.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = currency_converter.CurrencyConvertor.class.getResource(".");
